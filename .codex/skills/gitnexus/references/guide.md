...
| -------------------------------------------- | ----------------------- |
| Understand architecture / "How does X work?" | `references/exploring.md` |
| Blast radius / "What breaks if I change X?"  | `references/impact-analysis.md` |
| Trace bugs / "Why is X failing?"             | `references/debugging.md` |
| Rename / extract / split / refactor          | `references/refactoring.md` |
| Tools, resources, schema reference           | `references/guide.md` |
| Index, status, clean, wiki CLI commands      | `references/cli.md` |
